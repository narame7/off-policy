...
from offpolicy.envs.magym.magym_env import MagymEnv
...
def main(args):
    ...
    if all_args.algorithm_name in ["rmatd3", "rmaddpg", "rmasac", "qmix", "vdn"]:
        from offpolicy.runner.rnn.magym_runner import MagymRunner as Runner
        ...
        from offpolicy.runner.mlp.magym_runner import MagymRunner as Runner
